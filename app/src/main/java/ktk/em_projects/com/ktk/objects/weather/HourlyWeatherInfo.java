...
//    private Bitmap weatherIconIcon;
    ...
    public HourlyWeatherInfo(float tempC, String weatherIcon, String time, float pressure, int windSpeedKmph, int windDirDegree, int humidity, String description) {
        this.tempC = tempC;
